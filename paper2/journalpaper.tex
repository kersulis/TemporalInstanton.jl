...
\begin{figure}
\centering
\includegraphics[trim=0.3in 0.in 0.7in 0.4in,clip,width=1\linewidth]{temptrajectory}
...
\begin{figure}
\centering
\includegraphics[trim=0.3in 0.in 0.7in 0.4in,clip,width=1\linewidth]{covariance}
...
\begin{figure}
\centering
\includegraphics[trim=0in 0in 0in 0in,clip,width=1.05\linewidth]{rts-96-scaling-dots}
...
\begin{figure}
\centering
\includegraphics[trim=0in 0in 0in 0in,clip,width=\linewidth]{normalized-performance}
